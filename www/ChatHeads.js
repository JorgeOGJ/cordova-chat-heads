...
ChatHeads.start = function(successCallback, errorCallback){
	...
	var args = {};
	cordova.exec(successCallback, errorCallback, "ChatHeads", "startChatHeads", args);
};

ChatHeads.openHead = function(successCallback, errorCallback){
	console.log("ChatHeads Open");
	var args = {};
	cordova.exec(successCallback, errorCallback, "ChatHeads", "openChatHeads", args);
};
...
ChatHeads.test = function(successCallback, errorCallback){
	...
	var args = {};
	cordova.exec(successCallback, errorCallback, "ChatHeads", "test", [testmessage]);
};
